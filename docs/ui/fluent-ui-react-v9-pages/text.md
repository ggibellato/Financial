...
| `size` | `300 100 200 400 500 600 700 800 900 1000` | No | 300 | Applies font size and line height based on the theme typography tokens. |
...
export const StrikeThrough = (): JSXElement => (
...
export const Underline = (): JSXElement => (
