...
| `infoButton` | `WithSlotShorthandValue<Omit<ComponentProps<Partial<InfoButtonSlots>>, "disabled" | "popover"> & { size?: "small" | "medium" | "large"; inline?: boolean; popover?: NonNullable<...> | undefined; } & RefAttributes<...>> | null | undefined` | No |  | The InfoButton component.  It is not typically necessary to use this prop. The content can be set using the `info` prop of the InfoLabel. |
