...
export type AssetClassAllocationEntryDto = Schema<'AssetClassAllocationEntryDTO'>
export type CurrencyAllocationEntryDto = Schema<'CurrencyAllocationEntryDTO'>
export type CountryAllocationEntryDto = Schema<'CountryAllocationEntryDTO'>
export type BrokerAllocationEntryDto = Schema<'BrokerAllocationEntryDTO'>
export type DataQualityReportDto = Schema<'DataQualityReportDTO'>
export type SalesExceedPurchasesFindingDto = Schema<'SalesExceedPurchasesFinding'>
export type UnpricedOpenHoldingFindingDto = Schema<'UnpricedOpenHoldingFinding'>
export type OpenHoldingMissingCostBasisFindingDto = Schema<'OpenHoldingMissingCostBasisFinding'>
export type UnresolvedTaxClassificationFindingDto = Schema<'UnresolvedTaxClassificationFinding'>
