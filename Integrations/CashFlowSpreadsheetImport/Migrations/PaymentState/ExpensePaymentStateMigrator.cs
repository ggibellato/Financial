...
{
    public static PaymentStateMigrationSummary Migrate(CashFlowData data)
    {
        ArgumentNullException.ThrowIfNull(data);

        var summary = new PaymentStateMigrationSummary();
    ...
    private static void MigrateExpense(
        ...
        PaymentStateMigrationSummary summary)
    {
    ...
    private static void ReclassifyAsSettled(Expense expense, PaymentStateMigrationSummary summary)
    {
    ...
    private static void ReclassifyAsCharge(Expense expense, PaymentStateMigrationSummary summary)
    {
        if (expense.PaymentSource is null)
        {
            summary.CountAlreadyCharge();
