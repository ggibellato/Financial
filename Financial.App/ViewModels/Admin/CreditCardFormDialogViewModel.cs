...
/// <summary>
/// Collects a CreditCard's Name, IsActive and NextInvoiceDueDate for both Create and Edit, mirroring
...
/// </summary>
public sealed class CreditCardFormDialogViewModel : ViewModelBase
{
    private string _name;
    private bool _isActive;
    private DateTime? _nextInvoiceDueDate;
    private string _validationMessage = string.Empty;

    public bool IsEditing { get; }

    public string Title => IsEditing ? "Edit Credit Card" : "Create Credit Card";
    ...
    public DateTime? NextInvoiceDueDate
    {
        get => _nextInvoiceDueDate;
        set => SetProperty(ref _nextInvoiceDueDate, value);
    }
    ...
    public CreditCardFormDialogViewModel(
        string? currentName = null,
        bool currentIsActive = true,
        DateTime? currentNextInvoiceDueDate = null)
    {
        IsEditing = currentName is not null;
        _name = currentName ?? string.Empty;
        _isActive = currentIsActive;
        _nextInvoiceDueDate = currentNextInvoiceDueDate;
