...
internal static class AllocationPieChartBuilder
{
    // Same validated categorical palette used by the web equivalent and by
    // BrokerBreakdownChartBuilder, for cross-platform visual consistency.
