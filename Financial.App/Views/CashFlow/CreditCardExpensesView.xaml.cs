...
public partial class CreditCardExpensesView : UserControl
{
    ...
    private void OnDataContextChanged(object sender, System.Windows.DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            UnpaidCardChargesCategoryColumn.Header = viewModel.UnpaidCardChargesCategoryFilter;
            UnpaidCardChargesCardColumn.Header = viewModel.UnpaidCardChargesCardFilter;
        }
    }
}
