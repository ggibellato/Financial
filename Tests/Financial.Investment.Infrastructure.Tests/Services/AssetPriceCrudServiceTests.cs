...
public class AssetPriceCrudServiceTests
{
    ...
    private static (AssetPriceCrudService Service, string TempFile) CreateService()
    {
    ...
    private static (AssetPriceCrudService Service, InvestmentJsonRepository Repository, string TempFile) CreateServiceWithRepository()
    {
        ...
        var service = new AssetPriceCrudService(repository, navigationService, tracer, NullLogger<AssetPriceCrudService>.Instance);
