...
public class GoogleCalendarClientAdapterTests
{
    ...
    private GoogleCalendarClientAdapter CreateAdapter() => new(_oAuthClient, Options.Create(_settings));
    ...
    public async Task RefreshAccessTokenAsync_WhenGoogleRejectsTheRefreshToken_ThrowsApplicationLevelException()
    {
        ...
        await act.Should().ThrowAsync<GoogleCalendarTokenRevokedException>();
    }
