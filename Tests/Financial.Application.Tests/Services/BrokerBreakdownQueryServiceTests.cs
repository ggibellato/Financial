...
public class BrokerBreakdownQueryServiceTests
{
    ...
    {
        Action act = () => new BrokerBreakdownQueryService(null!);
    ...
    private BrokerBreakdownQueryService CreateService() => new(_repository);
